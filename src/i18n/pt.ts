  ...
  skills: {
    ...
    categories: [
      ...
      },
      {
        ...
        items: ["GitHub/Git", "Linux", "WordPress", "Puppeteer", "Webcrawler", "AWS (IAM, EC2, CloudWatch)", "CI/CD", "Docker"],
      },
      {
        title: "Metodologias",
        items: [
    ...
    items: [
      {
        ...
        bullets: [
          ...
          "Configuro e gerencio recursos de infraestrutura na AWS (IAM, EC2, CloudWatch) e pipelines de CI/CD para deploy e monitoramento da plataforma.",
        ],
      },
      {
